...
$sql=mysqli_query($con,"Update users set fullName='$fname',address='$address',city='$city',gender='$gender',profile='$profile' where id='".$_SESSION['id']."'");
if($sql)
{
...
$sql2=mysqli_query($con,"Update users set fullName='$fname',address='$address',city='$city',gender='$gender' where id='".$_SESSION['id']."'");
if($sql2)
{
$msg="Your Profile updated Successfully";
setcookie ("file_name", "", time() - 3600);
...
<?php } ?>
<hr />													<form id="myForm" role="form" name="edit" method="post">
